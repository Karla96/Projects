...
namespace Projekt.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public int OptimalCaloriesCounter(RegisterViewModel model)
        {
            var CurrentUser = User.Identity.GetUserId();
            if (model.Gender == 1)
            {
                if (model.SelectedLevel == 1)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((88.362 + (13.387 * model.CurrentWeight) +
                                       (4.799 * model.Height) - (5.677 * model.Age))*1.3);
                }

                else if (model.SelectedLevel == 2)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((88.362 + (13.387 * model.CurrentWeight) +
                                       (4.799 * model.Height) - (5.677 * model.Age))*1.5);
                   
                }

                else if (model.SelectedLevel == 3)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((88.362 + (13.387 * model.CurrentWeight) +
                                       (4.799 * model.Height) - (5.677 * model.Age))*1.7);
            ...
            else
            {
                if (model.SelectedLevel == 1)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((447.593 + (9.247 * model.CurrentWeight) +
                                       (3.098 * model.Height) - (4.330 * model.Age)) * 1.3);
                }

                else if (model.SelectedLevel == 2)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((447.593 + (9.247 * model.CurrentWeight) +
                                       (3.098 * model.Height) - (4.330 * model.Age))*1.5);
                }

                else if (model.SelectedLevel == 3)
                {
                    return model.CaloriesPerDay = Convert.ToInt32((447.593 + (9.247 * model.CurrentWeight) +
                                       (3.098 * model.Height) - (4.330 * model.Age)) * 1.7);
                }
                else
                    return 0;
        ...
        public int OptimalCaloriesCounter2(ExternalLoginConfirmationViewModel model)
        {
            var CurrentUser = User.Identity.GetUserId();
            if (model.Gender == 1)
            {
